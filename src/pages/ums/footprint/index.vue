...
import type { FootprintSearch, Footprint } from '@/api/ums/userApi'
import { _listFootprint } from '@/api/ums/userApi'
const data = ref<Array<Footprint>>([]);
const total = ref<number>(0)
const listQuery = reactive<Partial<FootprintSearch>>({
    pageNo: 1,
    order: 'create_time',
    userId: undefined,
    goodsId: undefined
...
const getList = () => {
    ...
    _listFootprint(listQuery as any).then(res => {
